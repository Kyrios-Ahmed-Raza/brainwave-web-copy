            ...
            <div className="p-4 bg-n-7 rounded-3xl overflow-hidden lg:min-h-[46rem]">
              <div className="py-12 px-4 xl:px-8">
                ...
                <p className="body-2 mb-[2rem] text-n-3">
                  The world&appos;s most powerful AI photo and video art
                  ...
                  {brainwaveServicesIcons.map((item, index) => (
                    <li
                      ...
                      className={`flex rounded-2xl items-center justify-center ${
                        index === 2
                          ? "size-[3rem] p-[2px] bg-conic-gradient md:size-[4.5rem]"
                    ...
                    >
                      <div
                        className={
                          index === 2
                            ? "flex items-center justify-center size-full bg-n-7 rounded-[.9rem]"
                            : ""
                        }
                      >
